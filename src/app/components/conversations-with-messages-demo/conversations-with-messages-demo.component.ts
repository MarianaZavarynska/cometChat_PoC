...
import { AvatarStyle, CometChatLocalize, CometChatTheme, CometChatThemeService, IncomingCallStyle, ListItemStyle, fontHelper } from '@cometchat/chat-uikit-angular';
...
export class ConversationsWithMessagesDemoComponent implements OnInit {
  ...
  //==================================== Oungoing Call ===========================================
  // public callSettingsBuilder:CometChat.CallSettingsBuilder = new CometChat.CallSettingsBuilder()
  // .setSessionID("session_id")
  // .enableDefaultLayout(true);

  // //create style object
  // ongoingCallStyle:CallscreenStyle = new CallscreenStyle({
  // minWidth: "320px",
  // minHeight: "320px",
  // minimizeIconTint: "700 28px Inter",
  // maximizeIconTint: "black",
  // })
  //==================================== Oungoing Call ===========================================
