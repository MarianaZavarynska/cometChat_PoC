...
import { OUTGOING_MESSAGE_SOUND } from "./resources/outgoingMsgSound";
  ...
  editMessage() {
    try {
      ...
      CometChat.editMessage(textMessage)
        ...
        .catch((error) => {
          this.messageSending = false;
          logger("Message editing failed with error:" as any, error);
        });
    } catch (error) {
      logger(error);
    }
  ...
  sendTextMessage(textMsg: String = "") : boolean {
    try {
      ...
      CometChat.sendMessage(textMessage)
        ...
        .catch((error) => {
          logger("Message sending failed with error:" as any, error);
          this.messageSending = false;
        });
    } catch (error) {
      logger(error);
  ...
  sendMediaMessage(messageInput: any, messageType: any) :boolean {
    try {
      ...
      CometChat.sendMessage(mediaMessage)
        ...
        .catch((error) => {
          this.messageSending = false;
          logger("message sending failed with error Message_Composer " as any, error);
        });
    } catch (error) {
      logger(error);
    }
  ...
  sendSticker(stickerMessage: any) {
    try {
      ...
      CometChat.sendCustomMessage(customMessage)
        ...
        .catch((error) => {
          this.messageSending = false;
          logger("custom message sending failed with error" as any, error);
        });
    } catch (error) {
      logger(error);
    }
