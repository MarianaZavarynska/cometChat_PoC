...
export class CallComponent  implements OnInit {
  ...
  startAudioCall(receiverUID: string) {
    ...
    CometChat.initiateCall(call).then( (callOne:any) => {
      debugger
      this.outgoingCall = callOne;
            ...
            const ongoingCallListener = new CometChat.OngoingCallListener({
              onCallEnded: (call: CometChat.Call) => {
                ...
                CometChat.endCall(call.getSessionId()).then((call)=> {
                  ...
                  console.log('======endCall=======', call)
                  console.log('======outGoing=======', this.outgoingCall)
                })
              },
